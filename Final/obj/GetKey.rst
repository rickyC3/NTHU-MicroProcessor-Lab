      ...
      000296                        288 _Get_Key:
                           ...
                           000000   296 	ar0 = 0x00
                                    ...
                                    298 ;	assignBit
      000296 D2 A2            [12]  299 	setb	_P2_2
                                    300 ;	./src/GetKey.c:14: but2 = 1;
                                    301 ;	assignBit
      000298 D2 A3            [12]  302 	setb	_P2_3
                                    303 ;	./src/GetKey.c:15: but3 = 1;
                                    304 ;	assignBit
      00029A D2 A4            [12]  305 	setb	_P2_4
                                    306 ;	./src/GetKey.c:16: o1 = 0;
                                    307 ;	assignBit
      00029C C2 A5            [12]  308 	clr	_P2_5
                                    309 ;	./src/GetKey.c:17: o2 = 1;
                                    310 ;	assignBit
      00029E D2 A6            [12]  311 	setb	_P2_6
                                    312 ;	./src/GetKey.c:18: o3 = 1;
                                    313 ;	assignBit
      0002A0 D2 A7            [12]  314 	setb	_P2_7
                                    315 ;	./src/GetKey.c:19: if (but1 == 0){
      0002A2 20 A2 04         [24]  316 	jb	_P2_2,00102$
                                    317 ;	./src/GetKey.c:20: return 1;
      0002A5 90 00 01         [24]  318 	mov	dptr,#0x0001
      0002A8 22               [24]  319 	ret
      0002A9                        320 00102$:
                                    321 ;	./src/GetKey.c:22: if (but2 == 0){
      0002A9 20 A3 04         [24]  322 	jb	_P2_3,00104$
                                    323 ;	./src/GetKey.c:23: return 2;
      0002AC 90 00 02         [24]  324 	mov	dptr,#0x0002
      0002AF 22               [24]  325 	ret
      0002B0                        326 00104$:
                                    327 ;	./src/GetKey.c:25: if (but3 == 0){
      0002B0 20 A4 04         [24]  328 	jb	_P2_4,00106$
                                    329 ;	./src/GetKey.c:26: return 3;
      0002B3 90 00 03         [24]  330 	mov	dptr,#0x0003
      0002B6 22               [24]  331 	ret
      0002B7                        332 00106$:
                                    333 ;	./src/GetKey.c:29: o1 = 1;
                                    334 ;	assignBit
      0002B7 D2 A5            [12]  335 	setb	_P2_5
                                    336 ;	./src/GetKey.c:30: o2 = 0;
                                    337 ;	assignBit
      0002B9 C2 A6            [12]  338 	clr	_P2_6
                                    339 ;	./src/GetKey.c:31: o3 = 1;
                                    340 ;	assignBit
      0002BB D2 A7            [12]  341 	setb	_P2_7
                                    342 ;	./src/GetKey.c:32: if (but1 == 0){
      0002BD 20 A2 04         [24]  343 	jb	_P2_2,00108$
                                    344 ;	./src/GetKey.c:33: return 4;
      0002C0 90 00 04         [24]  345 	mov	dptr,#0x0004
      0002C3 22               [24]  346 	ret
      0002C4                        347 00108$:
                                    348 ;	./src/GetKey.c:35: if (but2 == 0){
      0002C4 20 A3 04         [24]  349 	jb	_P2_3,00110$
                                    350 ;	./src/GetKey.c:36: return 5;
      0002C7 90 00 05         [24]  351 	mov	dptr,#0x0005
      0002CA 22               [24]  352 	ret
      0002CB                        353 00110$:
                                    354 ;	./src/GetKey.c:38: if (but3 == 0){
      0002CB 20 A4 04         [24]  355 	jb	_P2_4,00112$
                                    356 ;	./src/GetKey.c:39: return 6;
      0002CE 90 00 06         [24]  357 	mov	dptr,#0x0006
      0002D1 22               [24]  358 	ret
      0002D2                        359 00112$:
                                    360 ;	./src/GetKey.c:42: o1 = 1;
                                    361 ;	assignBit
      0002D2 D2 A5            [12]  362 	setb	_P2_5
                                    363 ;	./src/GetKey.c:43: o2 = 1;
                                    364 ;	assignBit
      0002D4 D2 A6            [12]  365 	setb	_P2_6
                                    366 ;	./src/GetKey.c:44: o3 = 0;
                                    367 ;	assignBit
      0002D6 C2 A7            [12]  368 	clr	_P2_7
                                    369 ;	./src/GetKey.c:45: if (but1 == 0){
      0002D8 20 A2 04         [24]  370 	jb	_P2_2,00114$
                                    371 ;	./src/GetKey.c:46: return 7;
      0002DB 90 00 07         [24]  372 	mov	dptr,#0x0007
      0002DE 22               [24]  373 	ret
      0002DF                        374 00114$:
                                    375 ;	./src/GetKey.c:48: if (but2 == 0){
      0002DF 20 A3 04         [24]  376 	jb	_P2_3,00116$
                                    377 ;	./src/GetKey.c:49: return 8;
      0002E2 90 00 08         [24]  378 	mov	dptr,#0x0008
      0002E5 22               [24]  379 	ret
      0002E6                        380 00116$:
                                    381 ;	./src/GetKey.c:51: if (but3 == 0){
      0002E6 20 A4 04         [24]  382 	jb	_P2_4,00118$
                                    383 ;	./src/GetKey.c:52: return 9;
      0002E9 90 00 09         [24]  384 	mov	dptr,#0x0009
      0002EC 22               [24]  385 	ret
      0002ED                        386 00118$:
                                    387 ;	./src/GetKey.c:55: return 0;
      0002ED 90 00 00         [24]  388 	mov	dptr,#0x0000
                                    389 ;	./src/GetKey.c:56: }
      0002F0 22               [24]  390 	ret
                                    391 	.area CSEG    (CODE)
                                    392 	.area CONST   (CODE)
                                    393 	.area XINIT   (CODE)
