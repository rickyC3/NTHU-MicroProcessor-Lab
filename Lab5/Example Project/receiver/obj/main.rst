      ...
      00001C                        294 	.ds	7
      000023 02 00 D5         [24]  295 	ljmp	_uart_isr
                                    296 ;--------------------------------------------------------
      ...
      000026 02 00 8B         [24]  319 	ljmp	_main
                                    ...
                                    327 ;------------------------------------------------------------
                                    328 ;i                         Allocated to registers r6 r7 
                                    329 ;------------------------------------------------------------
                                    330 ;	./src/main.c:8: void main(void)
                                    331 ;	-----------------------------------------
                                    332 ;	 function main
                                    333 ;	-----------------------------------------
      00008B                        334 _main:
                           ...
                           000001   341 	ar1 = 0x01
                           000000   342 	ar0 = 0x00
                                    343 ;	./src/main.c:11: TMOD = 0x20;			// set timer1 to mode2 
      00008B 75 89 20         [24]  344 	mov	_TMOD,#0x20
                                    345 ;	./src/main.c:12: SCON = 0x50;      // set serial mode1
      00008E 75 98 50         [24]  346 	mov	_SCON,#0x50
                                    347 ;	./src/main.c:13: TH1 = 250;     		// baudrate = 9600, fosc = 11.0592MHz
      000091 75 8D FA         [24]  348 	mov	_TH1,#0xfa
                                    349 ;	./src/main.c:14: TR1 = 1;				  // enable timer = 1
                                    350 ;	assignBit
      000094 D2 8E            [12]  351 	setb	_TR1
                                    352 ;	./src/main.c:15: IE = 0x90;				// enable serial port interrupt
      000096 75 A8 90         [24]  353 	mov	_IE,#0x90
                                    354 ;	./src/main.c:17: Initial();     	  // 7-seg initialization  
      000099 12 01 8E         [24]  355 	lcall	_Initial
                                    356 ;	./src/main.c:18: for (int i = 1; i < 9; i++)
      00009C 7E 01            [12]  357 	mov	r6,#0x01
      00009E 7F 00            [12]  358 	mov	r7,#0x00
      0000A0                        359 00108$:
      0000A0 C3               [12]  360 	clr	c
      0000A1 EE               [12]  361 	mov	a,r6
      0000A2 94 09            [12]  362 	subb	a,#0x09
      0000A4 EF               [12]  363 	mov	a,r7
      0000A5 64 80            [12]  364 	xrl	a,#0x80
      0000A7 94 80            [12]  365 	subb	a,#0x80
      0000A9 50 17            [24]  366 	jnc	00105$
                                    367 ;	./src/main.c:19: Write7219(i, 0x0F);      // Reset all digits as blank
      0000AB 8E 82            [24]  368 	mov	dpl,r6
      0000AD 75 0A 0F         [24]  369 	mov	_Write7219_PARM_2,#0x0f
      0000B0 C0 07            [24]  370 	push	ar7
      0000B2 C0 06            [24]  371 	push	ar6
      0000B4 12 01 2A         [24]  372 	lcall	_Write7219
      0000B7 D0 06            [24]  373 	pop	ar6
      0000B9 D0 07            [24]  374 	pop	ar7
                                    375 ;	./src/main.c:18: for (int i = 1; i < 9; i++)
      0000BB 0E               [12]  376 	inc	r6
                                    377 ;	./src/main.c:23: while(1) {
      0000BC BE 00 E1         [24]  378 	cjne	r6,#0x00,00108$
      0000BF 0F               [12]  379 	inc	r7
      0000C0 80 DE            [24]  380 	sjmp	00108$
      0000C2                        381 00105$:
                                    382 ;	./src/main.c:25: if (received_flag == 1) {      
      0000C2 74 01            [12]  383 	mov	a,#0x01
      0000C4 B5 09 FB         [24]  384 	cjne	a,_received_flag,00105$
                                    385 ;	./src/main.c:26: Write7219(1, received_data);      
      0000C7 85 08 0A         [24]  386 	mov	_Write7219_PARM_2,_received_data
      0000CA 75 82 01         [24]  387 	mov	dpl,#0x01
      0000CD 12 01 2A         [24]  388 	lcall	_Write7219
                                    389 ;	./src/main.c:27: received_flag = 0;
      0000D0 75 09 00         [24]  390 	mov	_received_flag,#0x00
                                    391 ;	./src/main.c:30: }
      0000D3 80 ED            [24]  392 	sjmp	00105$
                                    393 ;------------------------------------------------------------
                                    394 ;Allocation info for local variables in function 'uart_isr'
                                    395 ;------------------------------------------------------------
                                    396 ;	./src/main.c:33: void uart_isr(void) __interrupt (4) 
                                    397 ;	-----------------------------------------
                                    398 ;	 function uart_isr
                                    399 ;	-----------------------------------------
      0000D5                        400 _uart_isr:
                                    401 ;	./src/main.c:35: if( RI == 1) {
                                    402 ;	./src/main.c:36: RI = 0;                  // refresh RI
                                    403 ;	assignBit
      0000D5 10 98 02         [24]  404 	jbc	_RI,00109$
      0000D8 80 06            [24]  405 	sjmp	00103$
      0000DA                        406 00109$:
                                    407 ;	./src/main.c:37: received_data = SBUF;    // receive data from SBUF
      0000DA 85 99 08         [24]  408 	mov	_received_data,_SBUF
                                    409 ;	./src/main.c:38: received_flag = 1;       // receiving finished
      0000DD 75 09 01         [24]  410 	mov	_received_flag,#0x01
      0000E0                        411 00103$:
                                    412 ;	./src/main.c:40: }
      0000E0 32               [24]  413 	reti
                                    414 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    415 ;	eliminated unneeded push/pop not_psw
