      ...
      00058A 75 90 55         [24]  299 	mov	_P1,#0x55
                                    300 ;	./src/init_movie.c:8: delay_ms(200);
      00058D 90 00 C8         [24]  301 	mov	dptr,#0x00c8
      000590 12 04 01         [24]  302 	lcall	_delay_ms
                                    303 ;	./src/init_movie.c:9: LED = 0XAA;
      000593 75 90 AA         [24]  304 	mov	_P1,#0xaa
                                    305 ;	./src/init_movie.c:10: delay_ms(200);
      000596 90 00 C8         [24]  306 	mov	dptr,#0x00c8
      000599 12 04 01         [24]  307 	lcall	_delay_ms
                                    308 ;	./src/init_movie.c:11: LED = 0X55;
      00059C 75 90 55         [24]  309 	mov	_P1,#0x55
                                    310 ;	./src/init_movie.c:12: delay_ms(200);
      00059F 90 00 C8         [24]  311 	mov	dptr,#0x00c8
      0005A2 12 04 01         [24]  312 	lcall	_delay_ms
                                    313 ;	./src/init_movie.c:13: LED = 0XAA;
      0005A5 75 90 AA         [24]  314 	mov	_P1,#0xaa
                                    315 ;	./src/init_movie.c:14: delay_ms(200);
      0005A8 90 00 C8         [24]  316 	mov	dptr,#0x00c8
      0005AB 12 04 01         [24]  317 	lcall	_delay_ms
                                    318 ;	./src/init_movie.c:15: LED = 0X55;
      0005AE 75 90 55         [24]  319 	mov	_P1,#0x55
                                    320 ;	./src/init_movie.c:16: delay_ms(200);
      0005B1 90 00 C8         [24]  321 	mov	dptr,#0x00c8
      0005B4 12 04 01         [24]  322 	lcall	_delay_ms
                                    323 ;	./src/init_movie.c:17: LED = 0XAA;
      0005B7 75 90 AA         [24]  324 	mov	_P1,#0xaa
                                    325 ;	./src/init_movie.c:18: delay_ms(200);
      0005BA 90 00 C8         [24]  326 	mov	dptr,#0x00c8
      0005BD 12 04 01         [24]  327 	lcall	_delay_ms
                                    328 ;	./src/init_movie.c:19: LED = 0XFF;
      0005C0 75 90 FF         [24]  329 	mov	_P1,#0xff
                                    330 ;	./src/init_movie.c:20: delay_ms(500);
      0005C3 90 01 F4         [24]  331 	mov	dptr,#0x01f4
                                    332 ;	./src/init_movie.c:21: }
      0005C6 02 04 01         [24]  333 	ljmp	_delay_ms
                                    334 	.area CSEG    (CODE)
                                    335 	.area CONST   (CODE)
                                    336 	.area XINIT   (CODE)
