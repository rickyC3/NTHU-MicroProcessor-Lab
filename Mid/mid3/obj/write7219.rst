      ...
      000000                        225 	.ds 8
                                    ...
                                    228 ;--------------------------------------------------------
                                    229 	.area DSEG    (DATA)
      000038                        230 _Write7219_PARM_2:
      000038                        231 	.ds 1
      000039                        232 _Writesingle7219_PARM_2:
      000039                        233 	.ds 1
      00003A                        234 _Writesingle7219_PARM_3:
      00003A                        235 	.ds 1
                                    236 ;--------------------------------------------------------
                                    237 ; overlayable items in internal ram 
                                    238 ;--------------------------------------------------------
                                    239 	.area	OSEG    (OVR,DATA)
      00001E                        240 _sendbyte_PARM_2:
      00001E                        241 	.ds 1
                                    242 ;--------------------------------------------------------
      ...
      0009C1                        308 _sendbyte:
                           ...
                           000001   315 	ar1 = 0x01
                           000000   316 	ar0 = 0x00
      0009C1 AF 82            [24]  317 	mov	r7,dpl
                                    318 ;	./src/write7219.c:8: for (i = 0; i < 8; i++) {        // get last 8 bits(address)
      0009C3 7E 00            [12]  319 	mov	r6,#0x00
      0009C5                        320 00103$:
                                    321 ;	./src/write7219.c:9: CLK = 0;
                                    322 ;	assignBit
      0009C5 C2 A0            [12]  323 	clr	_P2_0
                                    324 ;	./src/write7219.c:10: DOUT = (address & 0x80);      // get msb and shift left
      0009C7 EF               [12]  325 	mov	a,r7
      0009C8 23               [12]  326 	rl	a
      0009C9 54 01            [12]  327 	anl	a,#0x01
                                    328 ;	assignBit
      0009CB 24 FF            [12]  329 	add	a,#0xff
      0009CD 92 A2            [24]  330 	mov	_P2_2,c
                                    331 ;	./src/write7219.c:11: address <<= 1; 
      0009CF 8F 05            [24]  332 	mov	ar5,r7
      0009D1 ED               [12]  333 	mov	a,r5
      0009D2 2D               [12]  334 	add	a,r5
      0009D3 FF               [12]  335 	mov	r7,a
                                    336 ;	./src/write7219.c:12: CLK = 1;
                                    337 ;	assignBit
      0009D4 D2 A0            [12]  338 	setb	_P2_0
                                    339 ;	./src/write7219.c:8: for (i = 0; i < 8; i++) {        // get last 8 bits(address)
      0009D6 0E               [12]  340 	inc	r6
      0009D7 BE 08 00         [24]  341 	cjne	r6,#0x08,00123$
      0009DA                        342 00123$:
      0009DA 40 E9            [24]  343 	jc	00103$
                                    344 ;	./src/write7219.c:14: for (i = 0; i < 8; i++) {        // get first 8 bits(data)
      0009DC 7F 00            [12]  345 	mov	r7,#0x00
      0009DE                        346 00105$:
                                    347 ;	./src/write7219.c:15: CLK = 0;
                                    348 ;	assignBit
      0009DE C2 A0            [12]  349 	clr	_P2_0
                                    350 ;	./src/write7219.c:16: DOUT = (dat & 0x80);          // get msb and shit left
      0009E0 E5 1E            [12]  351 	mov	a,_sendbyte_PARM_2
      0009E2 23               [12]  352 	rl	a
      0009E3 54 01            [12]  353 	anl	a,#0x01
                                    354 ;	assignBit
      0009E5 24 FF            [12]  355 	add	a,#0xff
      0009E7 92 A2            [24]  356 	mov	_P2_2,c
                                    357 ;	./src/write7219.c:17: dat <<= 1;
      0009E9 E5 1E            [12]  358 	mov	a,_sendbyte_PARM_2
      0009EB 25 E0            [12]  359 	add	a,acc
      0009ED F5 1E            [12]  360 	mov	_sendbyte_PARM_2,a
                                    361 ;	./src/write7219.c:18: CLK = 1;
                                    362 ;	assignBit
      0009EF D2 A0            [12]  363 	setb	_P2_0
                                    364 ;	./src/write7219.c:14: for (i = 0; i < 8; i++) {        // get first 8 bits(data)
      0009F1 0F               [12]  365 	inc	r7
      0009F2 BF 08 00         [24]  366 	cjne	r7,#0x08,00125$
      0009F5                        367 00125$:
      0009F5 40 E7            [24]  368 	jc	00105$
                                    369 ;	./src/write7219.c:20: }
      0009F7 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
                                    ...
                                    381 ;	-----------------------------------------
      0009F8                        382 _Write7219:
      0009F8 AF 82            [24]  383 	mov	r7,dpl
                                    384 ;	./src/write7219.c:27: LOAD = 0;
                                    385 ;	assignBit
      0009FA C2 A1            [12]  386 	clr	_P2_1
                                    387 ;	./src/write7219.c:28: for (cnt = 1; cnt <= matrixnum; cnt++) {        // send address and data according to the nuber of your matrix
      0009FC 7E 01            [12]  388 	mov	r6,#0x01
      0009FE                        389 00102$:
                                    390 ;	./src/write7219.c:29: sendbyte(address, dat);
      0009FE 85 38 1E         [24]  391 	mov	_sendbyte_PARM_2,_Write7219_PARM_2
      000A01 8F 82            [24]  392 	mov	dpl,r7
      000A03 C0 07            [24]  393 	push	ar7
      000A05 C0 06            [24]  394 	push	ar6
      000A07 12 09 C1         [24]  395 	lcall	_sendbyte
      000A0A D0 06            [24]  396 	pop	ar6
      000A0C D0 07            [24]  397 	pop	ar7
                                    398 ;	./src/write7219.c:28: for (cnt = 1; cnt <= matrixnum; cnt++) {        // send address and data according to the nuber of your matrix
      000A0E 0E               [12]  399 	inc	r6
      000A0F EE               [12]  400 	mov	a,r6
      000A10 24 FD            [12]  401 	add	a,#0xff - 0x02
      000A12 50 EA            [24]  402 	jnc	00102$
                                    403 ;	./src/write7219.c:31: LOAD = 1;                                       // after the load becomes 1, will the 7-segment display display
                                    404 ;	assignBit
      000A14 D2 A1            [12]  405 	setb	_P2_1
                                    406 ;	./src/write7219.c:32: }
      000A16 22               [24]  407 	ret
                                    408 ;------------------------------------------------------------
                                    ...
                                    419 ;	-----------------------------------------
      000A17                        420 _Writesingle7219:
      000A17 AF 82            [24]  421 	mov	r7,dpl
                                    422 ;	./src/write7219.c:39: LOAD = 0;
                                    423 ;	assignBit
      000A19 C2 A1            [12]  424 	clr	_P2_1
                                    425 ;	./src/write7219.c:40: for (cnt = matrixnum; cnt > chosen; cnt--) {    // write data into the selected matrix
      000A1B 7E 02            [12]  426 	mov	r6,#0x02
      000A1D                        427 00104$:
      000A1D C3               [12]  428 	clr	c
      000A1E EF               [12]  429 	mov	a,r7
      000A1F 9E               [12]  430 	subb	a,r6
      000A20 50 14            [24]  431 	jnc	00101$
                                    432 ;	./src/write7219.c:41: sendbyte(0x00, 0x00);                       // write 0 to no-op
      000A22 75 1E 00         [24]  433 	mov	_sendbyte_PARM_2,#0x00
      000A25 75 82 00         [24]  434 	mov	dpl,#0x00
      000A28 C0 07            [24]  435 	push	ar7
      000A2A C0 06            [24]  436 	push	ar6
      000A2C 12 09 C1         [24]  437 	lcall	_sendbyte
      000A2F D0 06            [24]  438 	pop	ar6
      000A31 D0 07            [24]  439 	pop	ar7
                                    440 ;	./src/write7219.c:40: for (cnt = matrixnum; cnt > chosen; cnt--) {    // write data into the selected matrix
      000A33 1E               [12]  441 	dec	r6
      000A34 80 E7            [24]  442 	sjmp	00104$
      000A36                        443 00101$:
                                    444 ;	./src/write7219.c:43: sendbyte(address, dat);                        // sent data to chosen led-matrix
      000A36 85 3A 1E         [24]  445 	mov	_sendbyte_PARM_2,_Writesingle7219_PARM_3
      000A39 85 39 82         [24]  446 	mov	dpl,_Writesingle7219_PARM_2
      000A3C C0 07            [24]  447 	push	ar7
      000A3E 12 09 C1         [24]  448 	lcall	_sendbyte
      000A41 D0 07            [24]  449 	pop	ar7
                                    450 ;	./src/write7219.c:44: for (cnt = chosen-1; cnt > 0; cnt--) { 
      000A43 1F               [12]  451 	dec	r7
      000A44                        452 00107$:
      000A44 EF               [12]  453 	mov	a,r7
      000A45 60 10            [24]  454 	jz	00102$
                                    455 ;	./src/write7219.c:45: sendbyte(0x00, 0x00);                       // write 0 to no-op
      000A47 75 1E 00         [24]  456 	mov	_sendbyte_PARM_2,#0x00
      000A4A 75 82 00         [24]  457 	mov	dpl,#0x00
      000A4D C0 07            [24]  458 	push	ar7
      000A4F 12 09 C1         [24]  459 	lcall	_sendbyte
      000A52 D0 07            [24]  460 	pop	ar7
                                    461 ;	./src/write7219.c:44: for (cnt = chosen-1; cnt > 0; cnt--) { 
      000A54 1F               [12]  462 	dec	r7
      000A55 80 ED            [24]  463 	sjmp	00107$
      000A57                        464 00102$:
                                    465 ;	./src/write7219.c:47: LOAD = 1;
                                    466 ;	assignBit
      000A57 D2 A1            [12]  467 	setb	_P2_1
                                    468 ;	./src/write7219.c:48: }
      000A59 22               [24]  469 	ret
                                    470 ;------------------------------------------------------------
                                    ...
                                    478 ;	-----------------------------------------
      000A5A                        479 _Initial7219:
                                    480 ;	./src/write7219.c:55: Write7219(SHUT_DOWN, 0x01);                     // normal mode(0xX1)
      000A5A 75 38 01         [24]  481 	mov	_Write7219_PARM_2,#0x01
      000A5D 75 82 0C         [24]  482 	mov	dpl,#0x0c
      000A60 12 09 F8         [24]  483 	lcall	_Write7219
                                    484 ;	./src/write7219.c:56: Write7219(DISPLAY_TEST, 0x00); 
      000A63 75 38 00         [24]  485 	mov	_Write7219_PARM_2,#0x00
      000A66 75 82 0F         [24]  486 	mov	dpl,#0x0f
      000A69 12 09 F8         [24]  487 	lcall	_Write7219
                                    488 ;	./src/write7219.c:57: Write7219(DECODE_MODE, 0x00);                   // select non-decode mode
      000A6C 75 38 00         [24]  489 	mov	_Write7219_PARM_2,#0x00
      000A6F 75 82 09         [24]  490 	mov	dpl,#0x09
      000A72 12 09 F8         [24]  491 	lcall	_Write7219
                                    492 ;	./src/write7219.c:58: Write7219(SCAN_LIMIT, 0x07);                    // use all 8 LED
      000A75 75 38 07         [24]  493 	mov	_Write7219_PARM_2,#0x07
      000A78 75 82 0B         [24]  494 	mov	dpl,#0x0b
      000A7B 12 09 F8         [24]  495 	lcall	_Write7219
                                    496 ;	./src/write7219.c:59: Write7219(INTENSITY, 0x00);                     // set up intensity
      000A7E 75 38 00         [24]  497 	mov	_Write7219_PARM_2,#0x00
      000A81 75 82 0A         [24]  498 	mov	dpl,#0x0a
      000A84 12 09 F8         [24]  499 	lcall	_Write7219
                                    500 ;	./src/write7219.c:60: for (i = 1; i <= 8; i++) {
      000A87 7F 01            [12]  501 	mov	r7,#0x01
      000A89                        502 00102$:
                                    503 ;	./src/write7219.c:61: Write7219(i, 0x00);                         // turn off all LED
      000A89 75 38 00         [24]  504 	mov	_Write7219_PARM_2,#0x00
      000A8C 8F 82            [24]  505 	mov	dpl,r7
      000A8E C0 07            [24]  506 	push	ar7
      000A90 12 09 F8         [24]  507 	lcall	_Write7219
      000A93 D0 07            [24]  508 	pop	ar7
                                    509 ;	./src/write7219.c:60: for (i = 1; i <= 8; i++) {
      000A95 0F               [12]  510 	inc	r7
      000A96 EF               [12]  511 	mov	a,r7
      000A97 24 F7            [12]  512 	add	a,#0xff - 0x08
      000A99 50 EE            [24]  513 	jnc	00102$
                                    514 ;	./src/write7219.c:63: }
      000A9B 22               [24]  515 	ret
                                    516 	.area CSEG    (CODE)
                                    517 	.area CONST   (CODE)
                                    518 	.area XINIT   (CODE)
