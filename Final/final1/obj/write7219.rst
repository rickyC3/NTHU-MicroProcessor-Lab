      ...
      000000                        225 	.ds 8
                                    ...
                                    228 ;--------------------------------------------------------
                                    229 	.area DSEG    (DATA)
      000029                        230 _Write7219_PARM_2:
      000029                        231 	.ds 1
      00002A                        232 _Writesingle7219_PARM_2:
      00002A                        233 	.ds 1
      00002B                        234 _Writesingle7219_PARM_3:
      00002B                        235 	.ds 1
                                    236 ;--------------------------------------------------------
                                    237 ; overlayable items in internal ram 
                                    238 ;--------------------------------------------------------
                                    239 	.area	OSEG    (OVR,DATA)
      00002C                        240 _sendbyte_PARM_2:
      00002C                        241 	.ds 1
                                    242 ;--------------------------------------------------------
      ...
      00027D                        308 _sendbyte:
                           ...
                           000001   315 	ar1 = 0x01
                           000000   316 	ar0 = 0x00
      00027D AF 82            [24]  317 	mov	r7,dpl
                                    318 ;	./src/write7219.c:8: for (i = 0; i < 8; i++) {        // get last 8 bits(address)
      00027F 7E 00            [12]  319 	mov	r6,#0x00
      000281                        320 00103$:
                                    321 ;	./src/write7219.c:9: CLK = 0;
                                    322 ;	assignBit
      000281 C2 A0            [12]  323 	clr	_P2_0
                                    324 ;	./src/write7219.c:10: DOUT = (address & 0x80);      // get msb and shift left
      000283 EF               [12]  325 	mov	a,r7
      000284 23               [12]  326 	rl	a
      000285 54 01            [12]  327 	anl	a,#0x01
                                    328 ;	assignBit
      000287 24 FF            [12]  329 	add	a,#0xff
      000289 92 A2            [24]  330 	mov	_P2_2,c
                                    331 ;	./src/write7219.c:11: address <<= 1; 
      00028B 8F 05            [24]  332 	mov	ar5,r7
      00028D ED               [12]  333 	mov	a,r5
      00028E 2D               [12]  334 	add	a,r5
      00028F FF               [12]  335 	mov	r7,a
                                    336 ;	./src/write7219.c:12: CLK = 1;
                                    337 ;	assignBit
      000290 D2 A0            [12]  338 	setb	_P2_0
                                    339 ;	./src/write7219.c:8: for (i = 0; i < 8; i++) {        // get last 8 bits(address)
      000292 0E               [12]  340 	inc	r6
      000293 BE 08 00         [24]  341 	cjne	r6,#0x08,00123$
      000296                        342 00123$:
      000296 40 E9            [24]  343 	jc	00103$
                                    344 ;	./src/write7219.c:14: for (i = 0; i < 8; i++) {        // get first 8 bits(data)
      000298 7F 00            [12]  345 	mov	r7,#0x00
      00029A                        346 00105$:
                                    347 ;	./src/write7219.c:15: CLK = 0;
                                    348 ;	assignBit
      00029A C2 A0            [12]  349 	clr	_P2_0
                                    350 ;	./src/write7219.c:16: DOUT = (dat & 0x80);          // get msb and shit left
      00029C E5 2C            [12]  351 	mov	a,_sendbyte_PARM_2
      00029E 23               [12]  352 	rl	a
      00029F 54 01            [12]  353 	anl	a,#0x01
                                    354 ;	assignBit
      0002A1 24 FF            [12]  355 	add	a,#0xff
      0002A3 92 A2            [24]  356 	mov	_P2_2,c
                                    357 ;	./src/write7219.c:17: dat <<= 1;
      0002A5 E5 2C            [12]  358 	mov	a,_sendbyte_PARM_2
      0002A7 25 E0            [12]  359 	add	a,acc
      0002A9 F5 2C            [12]  360 	mov	_sendbyte_PARM_2,a
                                    361 ;	./src/write7219.c:18: CLK = 1;
                                    362 ;	assignBit
      0002AB D2 A0            [12]  363 	setb	_P2_0
                                    364 ;	./src/write7219.c:14: for (i = 0; i < 8; i++) {        // get first 8 bits(data)
      0002AD 0F               [12]  365 	inc	r7
      0002AE BF 08 00         [24]  366 	cjne	r7,#0x08,00125$
      0002B1                        367 00125$:
      0002B1 40 E7            [24]  368 	jc	00105$
                                    369 ;	./src/write7219.c:20: }
      0002B3 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
                                    ...
                                    381 ;	-----------------------------------------
      0002B4                        382 _Write7219:
      0002B4 AF 82            [24]  383 	mov	r7,dpl
                                    384 ;	./src/write7219.c:27: LOAD = 0;
                                    385 ;	assignBit
      0002B6 C2 A1            [12]  386 	clr	_P2_1
                                    387 ;	./src/write7219.c:28: for (cnt = 1; cnt <= matrixnum; cnt++) {        // send address and data according to the nuber of your matrix
      0002B8 7E 01            [12]  388 	mov	r6,#0x01
      0002BA                        389 00102$:
                                    390 ;	./src/write7219.c:29: sendbyte (address, dat);
      0002BA 85 29 2C         [24]  391 	mov	_sendbyte_PARM_2,_Write7219_PARM_2
      0002BD 8F 82            [24]  392 	mov	dpl,r7
      0002BF C0 07            [24]  393 	push	ar7
      0002C1 C0 06            [24]  394 	push	ar6
      0002C3 12 02 7D         [24]  395 	lcall	_sendbyte
      0002C6 D0 06            [24]  396 	pop	ar6
      0002C8 D0 07            [24]  397 	pop	ar7
                                    398 ;	./src/write7219.c:28: for (cnt = 1; cnt <= matrixnum; cnt++) {        // send address and data according to the nuber of your matrix
      0002CA 0E               [12]  399 	inc	r6
      0002CB EE               [12]  400 	mov	a,r6
      0002CC 24 FE            [12]  401 	add	a,#0xff - 0x01
      0002CE 50 EA            [24]  402 	jnc	00102$
                                    403 ;	./src/write7219.c:31: LOAD = 1;                                       // after the load becomes 1, will the 7-segment display display
                                    404 ;	assignBit
      0002D0 D2 A1            [12]  405 	setb	_P2_1
                                    406 ;	./src/write7219.c:32: }
      0002D2 22               [24]  407 	ret
                                    408 ;------------------------------------------------------------
                                    ...
                                    419 ;	-----------------------------------------
      0002D3                        420 _Writesingle7219:
      0002D3 AF 82            [24]  421 	mov	r7,dpl
                                    422 ;	./src/write7219.c:39: LOAD = 0;
                                    423 ;	assignBit
      0002D5 C2 A1            [12]  424 	clr	_P2_1
                                    425 ;	./src/write7219.c:40: for (cnt = matrixnum; cnt > chosen; cnt--) {    // write data into the selected matrix
      0002D7 7E 01            [12]  426 	mov	r6,#0x01
      0002D9                        427 00104$:
      0002D9 C3               [12]  428 	clr	c
      0002DA EF               [12]  429 	mov	a,r7
      0002DB 9E               [12]  430 	subb	a,r6
      0002DC 50 14            [24]  431 	jnc	00101$
                                    432 ;	./src/write7219.c:41: sendbyte (0x00, 0x00);                      // write 0 to no-op
      0002DE 75 2C 00         [24]  433 	mov	_sendbyte_PARM_2,#0x00
      0002E1 75 82 00         [24]  434 	mov	dpl,#0x00
      0002E4 C0 07            [24]  435 	push	ar7
      0002E6 C0 06            [24]  436 	push	ar6
      0002E8 12 02 7D         [24]  437 	lcall	_sendbyte
      0002EB D0 06            [24]  438 	pop	ar6
      0002ED D0 07            [24]  439 	pop	ar7
                                    440 ;	./src/write7219.c:40: for (cnt = matrixnum; cnt > chosen; cnt--) {    // write data into the selected matrix
      0002EF 1E               [12]  441 	dec	r6
      0002F0 80 E7            [24]  442 	sjmp	00104$
      0002F2                        443 00101$:
                                    444 ;	./src/write7219.c:43: sendbyte (address, dat);                        // sent data to chosen led-matrix
      0002F2 85 2B 2C         [24]  445 	mov	_sendbyte_PARM_2,_Writesingle7219_PARM_3
      0002F5 85 2A 82         [24]  446 	mov	dpl,_Writesingle7219_PARM_2
      0002F8 C0 07            [24]  447 	push	ar7
      0002FA 12 02 7D         [24]  448 	lcall	_sendbyte
      0002FD D0 07            [24]  449 	pop	ar7
                                    450 ;	./src/write7219.c:44: for (cnt = chosen-1; cnt > 0; cnt--) { 
      0002FF 1F               [12]  451 	dec	r7
      000300                        452 00107$:
      000300 EF               [12]  453 	mov	a,r7
      000301 60 10            [24]  454 	jz	00102$
                                    455 ;	./src/write7219.c:45: sendbyte (0x00, 0x00);                      // write 0 to no-op
      000303 75 2C 00         [24]  456 	mov	_sendbyte_PARM_2,#0x00
      000306 75 82 00         [24]  457 	mov	dpl,#0x00
      000309 C0 07            [24]  458 	push	ar7
      00030B 12 02 7D         [24]  459 	lcall	_sendbyte
      00030E D0 07            [24]  460 	pop	ar7
                                    461 ;	./src/write7219.c:44: for (cnt = chosen-1; cnt > 0; cnt--) { 
      000310 1F               [12]  462 	dec	r7
      000311 80 ED            [24]  463 	sjmp	00107$
      000313                        464 00102$:
                                    465 ;	./src/write7219.c:47: LOAD = 1;
                                    466 ;	assignBit
      000313 D2 A1            [12]  467 	setb	_P2_1
                                    468 ;	./src/write7219.c:48: }
      000315 22               [24]  469 	ret
                                    470 ;------------------------------------------------------------
                                    ...
                                    478 ;	-----------------------------------------
      000316                        479 _Initial7219:
                                    480 ;	./src/write7219.c:55: Write7219(SHUT_DOWN, 0x01);                     // normal mode(0xX1)
      000316 75 29 01         [24]  481 	mov	_Write7219_PARM_2,#0x01
      000319 75 82 0C         [24]  482 	mov	dpl,#0x0c
      00031C 12 02 B4         [24]  483 	lcall	_Write7219
                                    484 ;	./src/write7219.c:56: Write7219(DISPLAY_TEST, 0x00); 
      00031F 75 29 00         [24]  485 	mov	_Write7219_PARM_2,#0x00
      000322 75 82 0F         [24]  486 	mov	dpl,#0x0f
      000325 12 02 B4         [24]  487 	lcall	_Write7219
                                    488 ;	./src/write7219.c:57: Write7219(DECODE_MODE, 0x00);                   // select non-decode mode
      000328 75 29 00         [24]  489 	mov	_Write7219_PARM_2,#0x00
      00032B 75 82 09         [24]  490 	mov	dpl,#0x09
      00032E 12 02 B4         [24]  491 	lcall	_Write7219
                                    492 ;	./src/write7219.c:58: Write7219(SCAN_LIMIT, 0x07);                    // use all 8 LED
      000331 75 29 07         [24]  493 	mov	_Write7219_PARM_2,#0x07
      000334 75 82 0B         [24]  494 	mov	dpl,#0x0b
      000337 12 02 B4         [24]  495 	lcall	_Write7219
                                    496 ;	./src/write7219.c:59: Write7219(INTENSITY, 0x00);                     // set up intensity
      00033A 75 29 00         [24]  497 	mov	_Write7219_PARM_2,#0x00
      00033D 75 82 0A         [24]  498 	mov	dpl,#0x0a
      000340 12 02 B4         [24]  499 	lcall	_Write7219
                                    500 ;	./src/write7219.c:60: for(i = 1; i <= 8; i++) {
      000343 7F 01            [12]  501 	mov	r7,#0x01
      000345                        502 00102$:
                                    503 ;	./src/write7219.c:61: Write7219 (i, 0x00);                        // turn off all LED
      000345 75 29 00         [24]  504 	mov	_Write7219_PARM_2,#0x00
      000348 8F 82            [24]  505 	mov	dpl,r7
      00034A C0 07            [24]  506 	push	ar7
      00034C 12 02 B4         [24]  507 	lcall	_Write7219
      00034F D0 07            [24]  508 	pop	ar7
                                    509 ;	./src/write7219.c:60: for(i = 1; i <= 8; i++) {
      000351 0F               [12]  510 	inc	r7
      000352 EF               [12]  511 	mov	a,r7
      000353 24 F7            [12]  512 	add	a,#0xff - 0x08
      000355 50 EE            [24]  513 	jnc	00102$
                                    514 ;	./src/write7219.c:63: }
      000357 22               [24]  515 	ret
                                    516 	.area CSEG    (CODE)
                                    517 	.area CONST   (CODE)
                                    518 	.area XINIT   (CODE)
