      ...
      0003A0                        301 _sendbyte:
                           ...
                           000001   308 	ar1 = 0x01
                           000000   309 	ar0 = 0x00
      0003A0 AF 82            [24]  310 	mov	r7,dpl
                                    311 ;	./src/seven_segment.c:7: for (i=0; i<8; i++)
      0003A2 7E 00            [12]  312 	mov	r6,#0x00
      0003A4                        313 00103$:
                                    314 ;	./src/seven_segment.c:9: CLK = 0;
                                    315 ;	assignBit
      0003A4 C2 A0            [12]  316 	clr	_P2_0
                                    317 ;	./src/seven_segment.c:10: DIN = (address & 0x80);
      0003A6 EF               [12]  318 	mov	a,r7
      0003A7 23               [12]  319 	rl	a
      0003A8 54 01            [12]  320 	anl	a,#0x01
                                    321 ;	assignBit
      0003AA 24 FF            [12]  322 	add	a,#0xff
      0003AC 92 A1            [24]  323 	mov	_P2_1,c
                                    324 ;	./src/seven_segment.c:11: address <<= 1;
      0003AE 8F 05            [24]  325 	mov	ar5,r7
      0003B0 ED               [12]  326 	mov	a,r5
      0003B1 2D               [12]  327 	add	a,r5
      0003B2 FF               [12]  328 	mov	r7,a
                                    329 ;	./src/seven_segment.c:12: CLK = 1;
                                    330 ;	assignBit
      0003B3 D2 A0            [12]  331 	setb	_P2_0
                                    332 ;	./src/seven_segment.c:7: for (i=0; i<8; i++)
      0003B5 0E               [12]  333 	inc	r6
      0003B6 BE 08 00         [24]  334 	cjne	r6,#0x08,00123$
      0003B9                        335 00123$:
      0003B9 40 E9            [24]  336 	jc	00103$
                                    337 ;	./src/seven_segment.c:15: for (i=0; i<8; i++)
      0003BB 7F 00            [12]  338 	mov	r7,#0x00
      0003BD                        339 00105$:
                                    340 ;	./src/seven_segment.c:17: CLK = 0;
                                    341 ;	assignBit
      0003BD C2 A0            [12]  342 	clr	_P2_0
                                    343 ;	./src/seven_segment.c:18: DIN = (dat & 0x80);
      0003BF E5 13            [12]  344 	mov	a,_sendbyte_PARM_2
      0003C1 23               [12]  345 	rl	a
      0003C2 54 01            [12]  346 	anl	a,#0x01
                                    347 ;	assignBit
      0003C4 24 FF            [12]  348 	add	a,#0xff
      0003C6 92 A1            [24]  349 	mov	_P2_1,c
                                    350 ;	./src/seven_segment.c:19: dat <<= 1;
      0003C8 E5 13            [12]  351 	mov	a,_sendbyte_PARM_2
      0003CA 25 E0            [12]  352 	add	a,acc
      0003CC F5 13            [12]  353 	mov	_sendbyte_PARM_2,a
                                    354 ;	./src/seven_segment.c:20: CLK = 1;
                                    355 ;	assignBit
      0003CE D2 A0            [12]  356 	setb	_P2_0
                                    357 ;	./src/seven_segment.c:15: for (i=0; i<8; i++)
      0003D0 0F               [12]  358 	inc	r7
      0003D1 BF 08 00         [24]  359 	cjne	r7,#0x08,00125$
      0003D4                        360 00125$:
      0003D4 40 E7            [24]  361 	jc	00105$
                                    362 ;	./src/seven_segment.c:22: }
      0003D6 22               [24]  363 	ret
                                    364 ;------------------------------------------------------------
                                    ...
                                    374 ;	-----------------------------------------
      0003D7                        375 _Write7219:
      0003D7 AF 82            [24]  376 	mov	r7,dpl
                                    377 ;	./src/seven_segment.c:27: LOAD_MAX = 0;
                                    378 ;	assignBit
      0003D9 C2 A4            [12]  379 	clr	_P2_4
                                    380 ;	./src/seven_segment.c:28: for(cnt=1; cnt<=matrixnum; cnt++)
      0003DB 7E 01            [12]  381 	mov	r6,#0x01
      0003DD                        382 00102$:
                                    383 ;	./src/seven_segment.c:30: sendbyte(address, dat);
      0003DD 85 12 13         [24]  384 	mov	_sendbyte_PARM_2,_Write7219_PARM_2
      0003E0 8F 82            [24]  385 	mov	dpl,r7
      0003E2 C0 07            [24]  386 	push	ar7
      0003E4 C0 06            [24]  387 	push	ar6
      0003E6 12 03 A0         [24]  388 	lcall	_sendbyte
      0003E9 D0 06            [24]  389 	pop	ar6
      0003EB D0 07            [24]  390 	pop	ar7
                                    391 ;	./src/seven_segment.c:28: for(cnt=1; cnt<=matrixnum; cnt++)
      0003ED 0E               [12]  392 	inc	r6
      0003EE EE               [12]  393 	mov	a,r6
      0003EF 24 FE            [12]  394 	add	a,#0xff - 0x01
      0003F1 50 EA            [24]  395 	jnc	00102$
                                    396 ;	./src/seven_segment.c:32: LOAD_MAX = 1;
                                    397 ;	assignBit
      0003F3 D2 A4            [12]  398 	setb	_P2_4
                                    399 ;	./src/seven_segment.c:33: }
      0003F5 22               [24]  400 	ret
                                    401 ;------------------------------------------------------------
      ...
      0003F6 75 12 01         [24]  412 	mov	_Write7219_PARM_2,#0x01
      0003F9 75 82 0C         [24]  413 	mov	dpl,#0x0c
      0003FC 12 03 D7         [24]  414 	lcall	_Write7219
                                    415 ;	./src/seven_segment.c:39: Write7219(DISPLAY_TEST, 0x00);
      0003FF 75 12 00         [24]  416 	mov	_Write7219_PARM_2,#0x00
      000402 75 82 0F         [24]  417 	mov	dpl,#0x0f
      000405 12 03 D7         [24]  418 	lcall	_Write7219
                                    419 ;	./src/seven_segment.c:40: Write7219(DECODE_MODE, 0x00);
      000408 75 12 00         [24]  420 	mov	_Write7219_PARM_2,#0x00
      00040B 75 82 09         [24]  421 	mov	dpl,#0x09
      00040E 12 03 D7         [24]  422 	lcall	_Write7219
                                    423 ;	./src/seven_segment.c:41: Write7219(SCAN_LIMIT, 0x07);
      000411 75 12 07         [24]  424 	mov	_Write7219_PARM_2,#0x07
      000414 75 82 0B         [24]  425 	mov	dpl,#0x0b
      000417 12 03 D7         [24]  426 	lcall	_Write7219
                                    427 ;	./src/seven_segment.c:42: Write7219(INTENSITY, 0x00);
      00041A 75 12 00         [24]  428 	mov	_Write7219_PARM_2,#0x00
      00041D 75 82 0A         [24]  429 	mov	dpl,#0x0a
      000420 12 03 D7         [24]  430 	lcall	_Write7219
                                    431 ;	./src/seven_segment.c:44: for(i=1; i<=8; i++){
      000423 7F 01            [12]  432 	mov	r7,#0x01
      000425                        433 00102$:
                                    434 ;	./src/seven_segment.c:45: Write7219(i, 0x00);
      000425 75 12 00         [24]  435 	mov	_Write7219_PARM_2,#0x00
      000428 8F 82            [24]  436 	mov	dpl,r7
      00042A C0 07            [24]  437 	push	ar7
      00042C 12 03 D7         [24]  438 	lcall	_Write7219
      00042F D0 07            [24]  439 	pop	ar7
                                    440 ;	./src/seven_segment.c:44: for(i=1; i<=8; i++){
      000431 0F               [12]  441 	inc	r7
      000432 EF               [12]  442 	mov	a,r7
      000433 24 F7            [12]  443 	add	a,#0xff - 0x08
      000435 50 EE            [24]  444 	jnc	00102$
                                    445 ;	./src/seven_segment.c:47: }
      000437 22               [24]  446 	ret
                                    447 	.area CSEG    (CODE)
                                    448 	.area CONST   (CODE)
                                    449 	.area XINIT   (CODE)
