...
;	./src/delay_func.c:119: __endasm;
	...
	MOV	R7, #1 ;
	RET
;	./src/delay_func.c:120: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Delay_So'
;------------------------------------------------------------
;	./src/delay_func.c:122: void Delay_So(void) {
;	-----------------------------------------
;	 function Delay_So
;	-----------------------------------------
_Delay_So:
;	./src/delay_func.c:149: __endasm;
	 DELAY_SO:
	MOV	R6,#10
	 DELAY_SO_DL1:
	MOV	R7,#13
	...
	MOV	R7, #1
	RET
;	./src/delay_func.c:150: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Delay_La'
;------------------------------------------------------------
;	./src/delay_func.c:152: void Delay_La(void) {
;	-----------------------------------------
;	 function Delay_La
;	-----------------------------------------
_Delay_La:
;	./src/delay_func.c:184: __endasm;
	 DELAY_LA:
	MOV	R6,#10
	 DELAY_LA_DL1:
	MOV	R7,#11
	...
	MOV	R7, #1
	RET
;	./src/delay_func.c:185: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Delay_Si'
;------------------------------------------------------------
;	./src/delay_func.c:187: void Delay_Si(void) {
;	-----------------------------------------
;	 function Delay_Si
;	-----------------------------------------
_Delay_Si:
