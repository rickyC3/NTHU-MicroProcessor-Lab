      ...
      00007F 75 08 B4         [24]  283 	mov	__addr,#0xb4
                                    284 ;--------------------------------------------------------
                                    285 ; Home
                                    286 ;--------------------------------------------------------
                                    287 	.area HOME    (CODE)
      ...
      00069B 75 82 07         [24]  310 	mov	dpl,#0x07
                                    311 ;	./src/MLX90614.c:8: }
      00069E 02 06 A7         [24]  312 	ljmp	_readTemp
                                    313 ;------------------------------------------------------------
                                    ...
                                    319 ;	-----------------------------------------
      0006A1                        320 _readAmbientTemp:
                                    321 ;	./src/MLX90614.c:11: return readTemp(AMBIENT_TEMP);
      0006A1 75 82 06         [24]  322 	mov	dpl,#0x06
                                    323 ;	./src/MLX90614.c:12: }
      0006A4 02 06 A7         [24]  324 	ljmp	_readTemp
                                    325 ;------------------------------------------------------------
                                    ...
                                    336 ;	-----------------------------------------
      0006A7                        337 _readTemp:
      0006A7 AF 82            [24]  338 	mov	r7,dpl
                                    339 ;	./src/MLX90614.c:19: I2C_Start();
      0006A9 C0 07            [24]  340 	push	ar7
      0006AB 12 08 3E         [24]  341 	lcall	_I2C_Start
                                    342 ;	./src/MLX90614.c:20: I2C_SendByte(_addr);            // 0xb4
      0006AE 85 08 82         [24]  343 	mov	dpl,__addr
      0006B1 12 08 7E         [24]  344 	lcall	_I2C_SendByte
      0006B4 D0 07            [24]  345 	pop	ar7
                                    346 ;	./src/MLX90614.c:21: I2C_SendByte(reg);
      0006B6 8F 82            [24]  347 	mov	dpl,r7
      0006B8 12 08 7E         [24]  348 	lcall	_I2C_SendByte
                                    349 ;	./src/MLX90614.c:22: SDA = 1;                        // pull up 2 wires to restart
                                    350 ;	assignBit
      0006BB D2 81            [12]  351 	setb	_P0_1
                                    352 ;	./src/MLX90614.c:23: SCL = 1;                        
                                    353 ;	assignBit
      0006BD D2 80            [12]  354 	setb	_P0_0
                                    355 ;	./src/MLX90614.c:24: I2C_Start();                    // restart
      0006BF 12 08 3E         [24]  356 	lcall	_I2C_Start
                                    357 ;	./src/MLX90614.c:25: I2C_SendByte(_addr|0x01);       // 0xb4 --> 0xb5
      0006C2 E5 08            [12]  358 	mov	a,__addr
      0006C4 44 01            [12]  359 	orl	a,#0x01
      0006C6 F5 82            [12]  360 	mov	dpl,a
      0006C8 12 08 7E         [24]  361 	lcall	_I2C_SendByte
                                    362 ;	./src/MLX90614.c:26: tempData = I2C_RecvByte();      // LSByte
      0006CB 12 08 A6         [24]  363 	lcall	_I2C_RecvByte
      0006CE AF 82            [24]  364 	mov	r7,dpl
      0006D0 7E 00            [12]  365 	mov	r6,#0x00
                                    366 ;	./src/MLX90614.c:27: I2C_SendACK(0);
      0006D2 75 82 00         [24]  367 	mov	dpl,#0x00
      0006D5 C0 07            [24]  368 	push	ar7
      0006D7 C0 06            [24]  369 	push	ar6
      0006D9 12 08 59         [24]  370 	lcall	_I2C_SendACK
                                    371 ;	./src/MLX90614.c:28: tempData |= I2C_RecvByte() << 8;  // { MSByte , LSByte } 
      0006DC 12 08 A6         [24]  372 	lcall	_I2C_RecvByte
      0006DF AD 82            [24]  373 	mov	r5,dpl
      0006E1 D0 06            [24]  374 	pop	ar6
      0006E3 D0 07            [24]  375 	pop	ar7
      0006E5 8D 04            [24]  376 	mov	ar4,r5
      0006E7 7D 00            [12]  377 	mov	r5,#0x00
      0006E9 EF               [12]  378 	mov	a,r7
      0006EA 42 05            [12]  379 	orl	ar5,a
      0006EC EE               [12]  380 	mov	a,r6
      0006ED 42 04            [12]  381 	orl	ar4,a
                                    382 ;	./src/MLX90614.c:29: I2C_SendACK(0);
      0006EF 75 82 00         [24]  383 	mov	dpl,#0x00
      0006F2 C0 05            [24]  384 	push	ar5
      0006F4 C0 04            [24]  385 	push	ar4
      0006F6 12 08 59         [24]  386 	lcall	_I2C_SendACK
                                    387 ;	./src/MLX90614.c:30: pec = I2C_RecvByte();           // 8-bit pec 
      0006F9 12 08 A6         [24]  388 	lcall	_I2C_RecvByte
                                    389 ;	./src/MLX90614.c:31: I2C_SendACK(1);
      0006FC 75 82 01         [24]  390 	mov	dpl,#0x01
      0006FF 12 08 59         [24]  391 	lcall	_I2C_SendACK
                                    392 ;	./src/MLX90614.c:32: I2C_Stop();
      000702 12 08 4D         [24]  393 	lcall	_I2C_Stop
      000705 D0 04            [24]  394 	pop	ar4
      000707 D0 05            [24]  395 	pop	ar5
                                    396 ;	./src/MLX90614.c:33: temp = tempData;               // raw 16-bit tempData 
      000709 8D 82            [24]  397 	mov	dpl,r5
      00070B 8C 83            [24]  398 	mov	dph,r4
      00070D 12 0D 9A         [24]  399 	lcall	___uint2fs
      000710 AC 82            [24]  400 	mov	r4,dpl
      000712 AD 83            [24]  401 	mov	r5,dph
      000714 AE F0            [24]  402 	mov	r6,b
      000716 FF               [12]  403 	mov	r7,a
                                    404 ;	./src/MLX90614.c:34: temp *= 0.02;                  // calculate temperature in Celsius 
      000717 C0 04            [24]  405 	push	ar4
      000719 C0 05            [24]  406 	push	ar5
      00071B C0 06            [24]  407 	push	ar6
      00071D C0 07            [24]  408 	push	ar7
      00071F 90 D7 0A         [24]  409 	mov	dptr,#0xd70a
      000722 75 F0 A3         [24]  410 	mov	b,#0xa3
      000725 74 3C            [12]  411 	mov	a,#0x3c
      000727 12 0B 9F         [24]  412 	lcall	___fsmul
      00072A AC 82            [24]  413 	mov	r4,dpl
      00072C AD 83            [24]  414 	mov	r5,dph
      00072E AE F0            [24]  415 	mov	r6,b
      000730 FF               [12]  416 	mov	r7,a
      000731 E5 81            [12]  417 	mov	a,sp
      000733 24 FC            [12]  418 	add	a,#0xfc
      000735 F5 81            [12]  419 	mov	sp,a
                                    420 ;	./src/MLX90614.c:35: temp -= 273.15;
      000737 74 33            [12]  421 	mov	a,#0x33
      000739 C0 E0            [24]  422 	push	acc
      00073B 74 93            [12]  423 	mov	a,#0x93
      00073D C0 E0            [24]  424 	push	acc
      00073F 74 88            [12]  425 	mov	a,#0x88
      000741 C0 E0            [24]  426 	push	acc
      000743 74 43            [12]  427 	mov	a,#0x43
      000745 C0 E0            [24]  428 	push	acc
      000747 8C 82            [24]  429 	mov	dpl,r4
      000749 8D 83            [24]  430 	mov	dph,r5
      00074B 8E F0            [24]  431 	mov	b,r6
      00074D EF               [12]  432 	mov	a,r7
      00074E 12 0B 6B         [24]  433 	lcall	___fssub
      000751 AC 82            [24]  434 	mov	r4,dpl
      000753 AD 83            [24]  435 	mov	r5,dph
      000755 AE F0            [24]  436 	mov	r6,b
      000757 FF               [12]  437 	mov	r7,a
      000758 E5 81            [12]  438 	mov	a,sp
      00075A 24 FC            [12]  439 	add	a,#0xfc
      00075C F5 81            [12]  440 	mov	sp,a
                                    441 ;	./src/MLX90614.c:36: temp = temp * 10 ;             // in order to show 1 decimal bit
      00075E C0 04            [24]  442 	push	ar4
      000760 C0 05            [24]  443 	push	ar5
      000762 C0 06            [24]  444 	push	ar6
      000764 C0 07            [24]  445 	push	ar7
      000766 90 00 00         [24]  446 	mov	dptr,#0x0000
      000769 75 F0 20         [24]  447 	mov	b,#0x20
      00076C 74 41            [12]  448 	mov	a,#0x41
      00076E 12 0B 9F         [24]  449 	lcall	___fsmul
      000771 AC 82            [24]  450 	mov	r4,dpl
      000773 AD 83            [24]  451 	mov	r5,dph
      000775 AE F0            [24]  452 	mov	r6,b
      000777 FF               [12]  453 	mov	r7,a
      000778 E5 81            [12]  454 	mov	a,sp
      00077A 24 FC            [12]  455 	add	a,#0xfc
      00077C F5 81            [12]  456 	mov	sp,a
                                    457 ;	./src/MLX90614.c:38: return temp;
      00077E 8C 82            [24]  458 	mov	dpl,r4
      000780 8D 83            [24]  459 	mov	dph,r5
      000782 8E F0            [24]  460 	mov	b,r6
      000784 EF               [12]  461 	mov	a,r7
                                    462 ;	./src/MLX90614.c:39: }
      000785 22               [24]  463 	ret
                                    464 	.area CSEG    (CODE)
                                    465 	.area CONST   (CODE)
                                    466 	.area XINIT   (CODE)
