      ...
      0002ED                        294 _SPI_WR:
                           ...
                           000001   301 	ar1 = 0x01
                           000000   302 	ar0 = 0x00
      0002ED AF 82            [24]  303 	mov	r7,dpl
                                    304 ;	./src/adc.c:7: char data_out = 0;
      0002EF 7E 00            [12]  305 	mov	r6,#0x00
                                    306 ;	./src/adc.c:9: for(i=0;i<8;i++)  // 8 bit transaction
      0002F1 7D 00            [12]  307 	mov	r5,#0x00
      0002F3                        308 00104$:
                                    309 ;	./src/adc.c:11: data_out <<= 1;
      0002F3 8E 04            [24]  310 	mov	ar4,r6
      0002F5 EC               [12]  311 	mov	a,r4
      0002F6 2C               [12]  312 	add	a,r4
      0002F7 FE               [12]  313 	mov	r6,a
                                    314 ;	./src/adc.c:13: CLK = 0;
                                    315 ;	assignBit
      0002F8 C2 A0            [12]  316 	clr	_P2_0
                                    317 ;	./src/adc.c:14: delay_5();
      0002FA C0 07            [24]  318 	push	ar7
      0002FC C0 06            [24]  319 	push	ar6
      0002FE C0 05            [24]  320 	push	ar5
      000300 12 03 9B         [24]  321 	lcall	_delay_5
      000303 D0 05            [24]  322 	pop	ar5
      000305 D0 06            [24]  323 	pop	ar6
      000307 D0 07            [24]  324 	pop	ar7
                                    325 ;	./src/adc.c:15: DIN = (data_in & 0x80) ? 1 : 0;   // Send data_in via DIN to ADC (e.g. start bit, mode selection)
      000309 8F 03            [24]  326 	mov	ar3,r7
      00030B 53 03 80         [24]  327 	anl	ar3,#0x80
      00030E 7C 00            [12]  328 	mov	r4,#0x00
                                    329 ;	assignBit
      000310 EB               [12]  330 	mov	a,r3
      000311 4C               [12]  331 	orl	a,r4
      000312 24 FF            [12]  332 	add	a,#0xff
      000314 92 A1            [24]  333 	mov	_P2_1,c
                                    334 ;	./src/adc.c:16: delay_5();
      000316 C0 07            [24]  335 	push	ar7
      000318 C0 06            [24]  336 	push	ar6
      00031A C0 05            [24]  337 	push	ar5
      00031C 12 03 9B         [24]  338 	lcall	_delay_5
                                    339 ;	./src/adc.c:17: CLK = 1;
                                    340 ;	assignBit
      00031F D2 A0            [12]  341 	setb	_P2_0
                                    342 ;	./src/adc.c:18: delay_5();
      000321 12 03 9B         [24]  343 	lcall	_delay_5
      000324 D0 05            [24]  344 	pop	ar5
      000326 D0 06            [24]  345 	pop	ar6
      000328 D0 07            [24]  346 	pop	ar7
                                    347 ;	./src/adc.c:20: if(DOUT == 1)   // Read DOUT
      00032A 30 A2 03         [24]  348 	jnb	_P2_2,00102$
                                    349 ;	./src/adc.c:21: data_out = (data_out | 0x01);   // Store into data_out
      00032D 43 06 01         [24]  350 	orl	ar6,#0x01
      000330                        351 00102$:
                                    352 ;	./src/adc.c:22: data_in <<= 1;
      000330 8F 04            [24]  353 	mov	ar4,r7
      000332 EC               [12]  354 	mov	a,r4
      000333 2C               [12]  355 	add	a,r4
      000334 FF               [12]  356 	mov	r7,a
                                    357 ;	./src/adc.c:9: for(i=0;i<8;i++)  // 8 bit transaction
      000335 0D               [12]  358 	inc	r5
      000336 BD 08 00         [24]  359 	cjne	r5,#0x08,00122$
      000339                        360 00122$:
      000339 40 B8            [24]  361 	jc	00104$
                                    362 ;	./src/adc.c:24: return data_out;
      00033B 8E 82            [24]  363 	mov	dpl,r6
                                    364 ;	./src/adc.c:25: }
      00033D 22               [24]  365 	ret
                                    366 ;------------------------------------------------------------
                                    ...
                                    376 ;	-----------------------------------------
      00033E                        377 _read_adc3202:
      00033E AF 82            [24]  378 	mov	r7,dpl
                                    379 ;	./src/adc.c:33: LOAD = 0;
                                    380 ;	assignBit
      000340 C2 A3            [12]  381 	clr	_P2_3
                                    382 ;	./src/adc.c:36: SPI_WR(0x01);               // First byte transaction includes start bit
      000342 75 82 01         [24]  383 	mov	dpl,#0x01
      000345 C0 07            [24]  384 	push	ar7
      000347 12 02 ED         [24]  385 	lcall	_SPI_WR
      00034A D0 07            [24]  386 	pop	ar7
                                    387 ;	./src/adc.c:37: if(channel == 1)            // Channel 1: 11100000, to IR sensor
      00034C BF 01 0A         [24]  388 	cjne	r7,#0x01,00102$
                                    389 ;	./src/adc.c:38: spi_buff = SPI_WR(0xe0);  // Second byte transaction includes mode selection and higher 4 bit ADC output
      00034F 75 82 E0         [24]  390 	mov	dpl,#0xe0
      000352 12 02 ED         [24]  391 	lcall	_SPI_WR
      000355 AF 82            [24]  392 	mov	r7,dpl
      000357 80 08            [24]  393 	sjmp	00103$
      000359                        394 00102$:
                                    395 ;	./src/adc.c:40: spi_buff = SPI_WR(0xa0);  // Second byte transaction includes mode selection and higher 4 bit ADC output
      000359 75 82 A0         [24]  396 	mov	dpl,#0xa0
      00035C 12 02 ED         [24]  397 	lcall	_SPI_WR
      00035F AF 82            [24]  398 	mov	r7,dpl
      000361                        399 00103$:
                                    400 ;	./src/adc.c:41: data_buff = spi_buff & 0x0f;
      000361 53 07 0F         [24]  401 	anl	ar7,#0x0f
                                    402 ;	./src/adc.c:42: data_buff <<= 8;            // Store higher 4 bit ADC output
      000364 8F 06            [24]  403 	mov	ar6,r7
      000366 7F 00            [12]  404 	mov	r7,#0x00
                                    405 ;	./src/adc.c:44: spi_buff = SPI_WR(0x00);    // Third byte transaction includes lower 8 bit ADC output
      000368 75 82 00         [24]  406 	mov	dpl,#0x00
      00036B C0 07            [24]  407 	push	ar7
      00036D C0 06            [24]  408 	push	ar6
      00036F 12 02 ED         [24]  409 	lcall	_SPI_WR
      000372 AD 82            [24]  410 	mov	r5,dpl
      000374 D0 06            [24]  411 	pop	ar6
      000376 D0 07            [24]  412 	pop	ar7
                                    413 ;	./src/adc.c:45: data_buff = data_buff | spi_buff;   // Store higher 4 bit ADC output
      000378 7C 00            [12]  414 	mov	r4,#0x00
      00037A ED               [12]  415 	mov	a,r5
      00037B 4F               [12]  416 	orl	a,r7
      00037C F5 82            [12]  417 	mov	dpl,a
      00037E EC               [12]  418 	mov	a,r4
      00037F 4E               [12]  419 	orl	a,r6
      000380 F5 83            [12]  420 	mov	dph,a
                                    421 ;	./src/adc.c:47: LOAD = 1;  
                                    422 ;	assignBit
      000382 D2 A3            [12]  423 	setb	_P2_3
                                    424 ;	./src/adc.c:48: CLK = 0;
                                    425 ;	assignBit
      000384 C2 A0            [12]  426 	clr	_P2_0
                                    427 ;	./src/adc.c:49: DIN = 0;
                                    428 ;	assignBit
      000386 C2 A1            [12]  429 	clr	_P2_1
                                    430 ;	./src/adc.c:51: return data_buff;
                                    431 ;	./src/adc.c:52: }
      000388 22               [24]  432 	ret
                                    433 	.area CSEG    (CODE)
                                    434 	.area CONST   (CODE)
                                    435 	.area XINIT   (CODE)
