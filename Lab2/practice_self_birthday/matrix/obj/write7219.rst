      ...
      000000                        225 	.ds 8
                                    ...
                                    228 ;--------------------------------------------------------
                                    229 	.area DSEG    (DATA)
      000070                        230 _Write7219_PARM_2:
      000070                        231 	.ds 1
      000071                        232 _Writesingle7219_PARM_2:
      000071                        233 	.ds 1
      000072                        234 _Writesingle7219_PARM_3:
      000072                        235 	.ds 1
                                    236 ;--------------------------------------------------------
                                    237 ; overlayable items in internal ram
                                    238 ;--------------------------------------------------------
                                    239 	.area	OSEG    (OVR,DATA)
      000073                        240 _sendbyte_PARM_2:
      000073                        241 	.ds 1
                                    242 ;--------------------------------------------------------
      ...
      000420                        308 _sendbyte:
                           ...
                           000001   315 	ar1 = 0x01
                           000000   316 	ar0 = 0x00
      000420 AF 82            [24]  317 	mov	r7,dpl
                                    318 ;	./src/write7219.c:8: for (i = 0; i < 8; i++) {        // get last 8 bits(address)
      000422 7E 00            [12]  319 	mov	r6,#0x00
      000424                        320 00103$:
                                    321 ;	./src/write7219.c:9: CLK = 0;
                                    322 ;	assignBit
      000424 C2 A0            [12]  323 	clr	_P2_0
                                    324 ;	./src/write7219.c:10: DOUT = (address & 0x80);      // get msb and shift left
      000426 EF               [12]  325 	mov	a,r7
      000427 23               [12]  326 	rl	a
      000428 54 01            [12]  327 	anl	a,#0x01
                                    328 ;	assignBit
      00042A 24 FF            [12]  329 	add	a,#0xff
      00042C 92 A2            [24]  330 	mov	_P2_2,c
                                    331 ;	./src/write7219.c:11: address <<= 1; 
      00042E 8F 05            [24]  332 	mov	ar5,r7
      000430 ED               [12]  333 	mov	a,r5
      000431 2D               [12]  334 	add	a,r5
      000432 FF               [12]  335 	mov	r7,a
                                    336 ;	./src/write7219.c:12: CLK = 1;
                                    337 ;	assignBit
      000433 D2 A0            [12]  338 	setb	_P2_0
                                    339 ;	./src/write7219.c:8: for (i = 0; i < 8; i++) {        // get last 8 bits(address)
      000435 0E               [12]  340 	inc	r6
      000436 BE 08 00         [24]  341 	cjne	r6,#0x08,00123$
      000439                        342 00123$:
      000439 40 E9            [24]  343 	jc	00103$
                                    344 ;	./src/write7219.c:14: for (i = 0; i < 8; i++) {        // get first 8 bits(data)
      00043B 7F 00            [12]  345 	mov	r7,#0x00
      00043D                        346 00105$:
                                    347 ;	./src/write7219.c:15: CLK = 0;
                                    348 ;	assignBit
      00043D C2 A0            [12]  349 	clr	_P2_0
                                    350 ;	./src/write7219.c:16: DOUT = (dat & 0x80);          // get msb and shit left
      00043F E5 73            [12]  351 	mov	a,_sendbyte_PARM_2
      000441 23               [12]  352 	rl	a
      000442 54 01            [12]  353 	anl	a,#0x01
                                    354 ;	assignBit
      000444 24 FF            [12]  355 	add	a,#0xff
      000446 92 A2            [24]  356 	mov	_P2_2,c
                                    357 ;	./src/write7219.c:17: dat <<= 1;
      000448 E5 73            [12]  358 	mov	a,_sendbyte_PARM_2
      00044A 25 E0            [12]  359 	add	a,acc
      00044C F5 73            [12]  360 	mov	_sendbyte_PARM_2,a
                                    361 ;	./src/write7219.c:18: CLK = 1;
                                    362 ;	assignBit
      00044E D2 A0            [12]  363 	setb	_P2_0
                                    364 ;	./src/write7219.c:14: for (i = 0; i < 8; i++) {        // get first 8 bits(data)
      000450 0F               [12]  365 	inc	r7
      000451 BF 08 00         [24]  366 	cjne	r7,#0x08,00125$
      000454                        367 00125$:
      000454 40 E7            [24]  368 	jc	00105$
                                    369 ;	./src/write7219.c:20: }
      000456 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
                                    ...
                                    381 ;	-----------------------------------------
      000457                        382 _Write7219:
      000457 AF 82            [24]  383 	mov	r7,dpl
                                    384 ;	./src/write7219.c:27: LOAD = 0;
                                    385 ;	assignBit
      000459 C2 A1            [12]  386 	clr	_P2_1
                                    387 ;	./src/write7219.c:28: for (cnt = 1; cnt <= matrixnum; cnt++) {        // send address and data according to the nuber of your matrix
      00045B 7E 01            [12]  388 	mov	r6,#0x01
      00045D                        389 00102$:
                                    390 ;	./src/write7219.c:29: sendbyte(address, dat);
      00045D 85 70 73         [24]  391 	mov	_sendbyte_PARM_2,_Write7219_PARM_2
      000460 8F 82            [24]  392 	mov	dpl,r7
      000462 C0 07            [24]  393 	push	ar7
      000464 C0 06            [24]  394 	push	ar6
      000466 12 04 20         [24]  395 	lcall	_sendbyte
      000469 D0 06            [24]  396 	pop	ar6
      00046B D0 07            [24]  397 	pop	ar7
                                    398 ;	./src/write7219.c:28: for (cnt = 1; cnt <= matrixnum; cnt++) {        // send address and data according to the nuber of your matrix
      00046D 0E               [12]  399 	inc	r6
      00046E EE               [12]  400 	mov	a,r6
      00046F 24 FD            [12]  401 	add	a,#0xff - 0x02
      000471 50 EA            [24]  402 	jnc	00102$
                                    403 ;	./src/write7219.c:31: LOAD = 1;                                       // after the load becomes 1, will the 7-segment display display
                                    404 ;	assignBit
      000473 D2 A1            [12]  405 	setb	_P2_1
                                    406 ;	./src/write7219.c:32: }
      000475 22               [24]  407 	ret
                                    408 ;------------------------------------------------------------
                                    ...
                                    419 ;	-----------------------------------------
      000476                        420 _Writesingle7219:
      000476 AF 82            [24]  421 	mov	r7,dpl
                                    422 ;	./src/write7219.c:39: LOAD = 0;
                                    423 ;	assignBit
      000478 C2 A1            [12]  424 	clr	_P2_1
                                    425 ;	./src/write7219.c:40: for (cnt = matrixnum; cnt > chosen; cnt--) {    // write data into the selected matrix
      00047A 7E 02            [12]  426 	mov	r6,#0x02
      00047C                        427 00104$:
      00047C C3               [12]  428 	clr	c
      00047D EF               [12]  429 	mov	a,r7
      00047E 9E               [12]  430 	subb	a,r6
      00047F 50 14            [24]  431 	jnc	00101$
                                    432 ;	./src/write7219.c:41: sendbyte(0x00, 0x00);                       // write 0 to no-op
      000481 75 73 00         [24]  433 	mov	_sendbyte_PARM_2,#0x00
      000484 75 82 00         [24]  434 	mov	dpl,#0x00
      000487 C0 07            [24]  435 	push	ar7
      000489 C0 06            [24]  436 	push	ar6
      00048B 12 04 20         [24]  437 	lcall	_sendbyte
      00048E D0 06            [24]  438 	pop	ar6
      000490 D0 07            [24]  439 	pop	ar7
                                    440 ;	./src/write7219.c:40: for (cnt = matrixnum; cnt > chosen; cnt--) {    // write data into the selected matrix
      000492 1E               [12]  441 	dec	r6
      000493 80 E7            [24]  442 	sjmp	00104$
      000495                        443 00101$:
                                    444 ;	./src/write7219.c:43: sendbyte(address, dat);                        // sent data to chosen led-matrix
      000495 85 72 73         [24]  445 	mov	_sendbyte_PARM_2,_Writesingle7219_PARM_3
      000498 85 71 82         [24]  446 	mov	dpl,_Writesingle7219_PARM_2
      00049B C0 07            [24]  447 	push	ar7
      00049D 12 04 20         [24]  448 	lcall	_sendbyte
      0004A0 D0 07            [24]  449 	pop	ar7
                                    450 ;	./src/write7219.c:44: for (cnt = chosen-1; cnt > 0; cnt--) { 
      0004A2 1F               [12]  451 	dec	r7
      0004A3                        452 00107$:
      0004A3 EF               [12]  453 	mov	a,r7
      0004A4 60 10            [24]  454 	jz	00102$
                                    455 ;	./src/write7219.c:45: sendbyte(0x00, 0x00);                       // write 0 to no-op
      0004A6 75 73 00         [24]  456 	mov	_sendbyte_PARM_2,#0x00
      0004A9 75 82 00         [24]  457 	mov	dpl,#0x00
      0004AC C0 07            [24]  458 	push	ar7
      0004AE 12 04 20         [24]  459 	lcall	_sendbyte
      0004B1 D0 07            [24]  460 	pop	ar7
                                    461 ;	./src/write7219.c:44: for (cnt = chosen-1; cnt > 0; cnt--) { 
      0004B3 1F               [12]  462 	dec	r7
      0004B4 80 ED            [24]  463 	sjmp	00107$
      0004B6                        464 00102$:
                                    465 ;	./src/write7219.c:47: LOAD = 1;
                                    466 ;	assignBit
      0004B6 D2 A1            [12]  467 	setb	_P2_1
                                    468 ;	./src/write7219.c:48: }
      0004B8 22               [24]  469 	ret
                                    470 ;------------------------------------------------------------
                                    ...
                                    478 ;	-----------------------------------------
      0004B9                        479 _Initial7219:
                                    480 ;	./src/write7219.c:55: Write7219(SHUT_DOWN, 0x01);                     // normal mode(0xX1)
      0004B9 75 70 01         [24]  481 	mov	_Write7219_PARM_2,#0x01
      0004BC 75 82 0C         [24]  482 	mov	dpl,#0x0c
      0004BF 12 04 57         [24]  483 	lcall	_Write7219
                                    484 ;	./src/write7219.c:56: Write7219(DISPLAY_TEST, 0x00); 
      0004C2 75 70 00         [24]  485 	mov	_Write7219_PARM_2,#0x00
      0004C5 75 82 0F         [24]  486 	mov	dpl,#0x0f
      0004C8 12 04 57         [24]  487 	lcall	_Write7219
                                    488 ;	./src/write7219.c:57: Write7219(DECODE_MODE, 0x00);                   // select non-decode mode
      0004CB 75 70 00         [24]  489 	mov	_Write7219_PARM_2,#0x00
      0004CE 75 82 09         [24]  490 	mov	dpl,#0x09
      0004D1 12 04 57         [24]  491 	lcall	_Write7219
                                    492 ;	./src/write7219.c:58: Write7219(SCAN_LIMIT, 0x07);                    // use all 8 LED
      0004D4 75 70 07         [24]  493 	mov	_Write7219_PARM_2,#0x07
      0004D7 75 82 0B         [24]  494 	mov	dpl,#0x0b
      0004DA 12 04 57         [24]  495 	lcall	_Write7219
                                    496 ;	./src/write7219.c:59: Write7219(INTENSITY, 0x00);                     // set up intensity
      0004DD 75 70 00         [24]  497 	mov	_Write7219_PARM_2,#0x00
      0004E0 75 82 0A         [24]  498 	mov	dpl,#0x0a
      0004E3 12 04 57         [24]  499 	lcall	_Write7219
                                    500 ;	./src/write7219.c:60: for (i = 1; i <= 8; i++) {
      0004E6 7F 01            [12]  501 	mov	r7,#0x01
      0004E8                        502 00102$:
                                    503 ;	./src/write7219.c:61: Write7219(i, 0x00);                         // turn off all LED
      0004E8 75 70 00         [24]  504 	mov	_Write7219_PARM_2,#0x00
      0004EB 8F 82            [24]  505 	mov	dpl,r7
      0004ED C0 07            [24]  506 	push	ar7
      0004EF 12 04 57         [24]  507 	lcall	_Write7219
      0004F2 D0 07            [24]  508 	pop	ar7
                                    509 ;	./src/write7219.c:60: for (i = 1; i <= 8; i++) {
      0004F4 0F               [12]  510 	inc	r7
      0004F5 EF               [12]  511 	mov	a,r7
      0004F6 24 F7            [12]  512 	add	a,#0xff - 0x08
      0004F8 50 EE            [24]  513 	jnc	00102$
                                    514 ;	./src/write7219.c:63: }
      0004FA 22               [24]  515 	ret
                                    516 	.area CSEG    (CODE)
                                    517 	.area CONST   (CODE)
                                    518 	.area XINIT   (CODE)
