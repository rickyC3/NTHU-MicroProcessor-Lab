      ...
      000000                        225 	.ds 8
                                    ...
                                    228 ;--------------------------------------------------------
                                    229 	.area DSEG    (DATA)
      00003D                        230 _Write7219_PARM_2:
      00003D                        231 	.ds 1
      00003E                        232 _Writesingle7219_PARM_2:
      00003E                        233 	.ds 1
      00003F                        234 _Writesingle7219_PARM_3:
      00003F                        235 	.ds 1
                                    236 ;--------------------------------------------------------
                                    237 ; overlayable items in internal ram 
                                    238 ;--------------------------------------------------------
                                    239 	.area	OSEG    (OVR,DATA)
      000040                        240 _sendbyte_PARM_2:
      000040                        241 	.ds 1
                                    242 ;--------------------------------------------------------
      ...
      000AA5                        308 _sendbyte:
                           ...
                           000001   315 	ar1 = 0x01
                           000000   316 	ar0 = 0x00
      000AA5 AF 82            [24]  317 	mov	r7,dpl
                                    318 ;	./src/write7219.c:8: for (i = 0; i < 8; i++) {        // get last 8 bits(address)
      000AA7 7E 00            [12]  319 	mov	r6,#0x00
      000AA9                        320 00103$:
                                    321 ;	./src/write7219.c:9: CLK = 0;
                                    322 ;	assignBit
      000AA9 C2 A0            [12]  323 	clr	_P2_0
                                    324 ;	./src/write7219.c:10: DOUT = (address & 0x80);      // get msb and shift left
      000AAB EF               [12]  325 	mov	a,r7
      000AAC 23               [12]  326 	rl	a
      000AAD 54 01            [12]  327 	anl	a,#0x01
                                    328 ;	assignBit
      000AAF 24 FF            [12]  329 	add	a,#0xff
      000AB1 92 A2            [24]  330 	mov	_P2_2,c
                                    331 ;	./src/write7219.c:11: address <<= 1; 
      000AB3 8F 05            [24]  332 	mov	ar5,r7
      000AB5 ED               [12]  333 	mov	a,r5
      000AB6 2D               [12]  334 	add	a,r5
      000AB7 FF               [12]  335 	mov	r7,a
                                    336 ;	./src/write7219.c:12: CLK = 1;
                                    337 ;	assignBit
      000AB8 D2 A0            [12]  338 	setb	_P2_0
                                    339 ;	./src/write7219.c:8: for (i = 0; i < 8; i++) {        // get last 8 bits(address)
      000ABA 0E               [12]  340 	inc	r6
      000ABB BE 08 00         [24]  341 	cjne	r6,#0x08,00123$
      000ABE                        342 00123$:
      000ABE 40 E9            [24]  343 	jc	00103$
                                    344 ;	./src/write7219.c:14: for (i = 0; i < 8; i++) {        // get first 8 bits(data)
      000AC0 7F 00            [12]  345 	mov	r7,#0x00
      000AC2                        346 00105$:
                                    347 ;	./src/write7219.c:15: CLK = 0;
                                    348 ;	assignBit
      000AC2 C2 A0            [12]  349 	clr	_P2_0
                                    350 ;	./src/write7219.c:16: DOUT = (dat & 0x80);          // get msb and shit left
      000AC4 E5 40            [12]  351 	mov	a,_sendbyte_PARM_2
      000AC6 23               [12]  352 	rl	a
      000AC7 54 01            [12]  353 	anl	a,#0x01
                                    354 ;	assignBit
      000AC9 24 FF            [12]  355 	add	a,#0xff
      000ACB 92 A2            [24]  356 	mov	_P2_2,c
                                    357 ;	./src/write7219.c:17: dat <<= 1;
      000ACD E5 40            [12]  358 	mov	a,_sendbyte_PARM_2
      000ACF 25 E0            [12]  359 	add	a,acc
      000AD1 F5 40            [12]  360 	mov	_sendbyte_PARM_2,a
                                    361 ;	./src/write7219.c:18: CLK = 1;
                                    362 ;	assignBit
      000AD3 D2 A0            [12]  363 	setb	_P2_0
                                    364 ;	./src/write7219.c:14: for (i = 0; i < 8; i++) {        // get first 8 bits(data)
      000AD5 0F               [12]  365 	inc	r7
      000AD6 BF 08 00         [24]  366 	cjne	r7,#0x08,00125$
      000AD9                        367 00125$:
      000AD9 40 E7            [24]  368 	jc	00105$
                                    369 ;	./src/write7219.c:20: }
      000ADB 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
      ...
      000AFA 22               [24]  407 	ret
                                    ...
                                    419 ;	-----------------------------------------
      000AFB                        420 _Writesingle7219:
      000AFB AF 82            [24]  421 	mov	r7,dpl
                                    422 ;	./src/write7219.c:39: LOAD = 0;
                                    423 ;	assignBit
      000AFD C2 A1            [12]  424 	clr	_P2_1
                                    425 ;	./src/write7219.c:40: for (cnt = matrixnum; cnt > chosen; cnt--) {    // write data into the selected matrix
      000AFF 7E 02            [12]  426 	mov	r6,#0x02
      000B01                        427 00104$:
      000B01 C3               [12]  428 	clr	c
      000B02 EF               [12]  429 	mov	a,r7
      000B03 9E               [12]  430 	subb	a,r6
      000B04 50 14            [24]  431 	jnc	00101$
                                    432 ;	./src/write7219.c:41: sendbyte(0x00, 0x00);                       // write 0 to no-op
      000B06 75 40 00         [24]  433 	mov	_sendbyte_PARM_2,#0x00
      000B09 75 82 00         [24]  434 	mov	dpl,#0x00
      000B0C C0 07            [24]  435 	push	ar7
      000B0E C0 06            [24]  436 	push	ar6
      000B10 12 0A A5         [24]  437 	lcall	_sendbyte
      000B13 D0 06            [24]  438 	pop	ar6
      000B15 D0 07            [24]  439 	pop	ar7
                                    440 ;	./src/write7219.c:40: for (cnt = matrixnum; cnt > chosen; cnt--) {    // write data into the selected matrix
      000B17 1E               [12]  441 	dec	r6
      000B18 80 E7            [24]  442 	sjmp	00104$
      000B1A                        443 00101$:
                                    444 ;	./src/write7219.c:43: sendbyte(address, dat);                        // sent data to chosen led-matrix
      000B1A 85 3F 40         [24]  445 	mov	_sendbyte_PARM_2,_Writesingle7219_PARM_3
      000B1D 85 3E 82         [24]  446 	mov	dpl,_Writesingle7219_PARM_2
      000B20 C0 07            [24]  447 	push	ar7
      000B22 12 0A A5         [24]  448 	lcall	_sendbyte
      000B25 D0 07            [24]  449 	pop	ar7
                                    450 ;	./src/write7219.c:44: for (cnt = chosen-1; cnt > 0; cnt--) { 
      000B27 1F               [12]  451 	dec	r7
      000B28                        452 00107$:
      000B28 EF               [12]  453 	mov	a,r7
      000B29 60 10            [24]  454 	jz	00102$
                                    455 ;	./src/write7219.c:45: sendbyte(0x00, 0x00);                       // write 0 to no-op
      000B2B 75 40 00         [24]  456 	mov	_sendbyte_PARM_2,#0x00
      000B2E 75 82 00         [24]  457 	mov	dpl,#0x00
      000B31 C0 07            [24]  458 	push	ar7
      000B33 12 0A A5         [24]  459 	lcall	_sendbyte
      000B36 D0 07            [24]  460 	pop	ar7
                                    461 ;	./src/write7219.c:44: for (cnt = chosen-1; cnt > 0; cnt--) { 
      000B38 1F               [12]  462 	dec	r7
      000B39 80 ED            [24]  463 	sjmp	00107$
      000B3B                        464 00102$:
                                    465 ;	./src/write7219.c:47: LOAD = 1;
                                    466 ;	assignBit
      000B3B D2 A1            [12]  467 	setb	_P2_1
                                    468 ;	./src/write7219.c:48: }
      000B3D 22               [24]  469 	ret
                                    470 ;------------------------------------------------------------
                                    ...
                                    478 ;	-----------------------------------------
      000B3E                        479 _Initial7219:
                                    480 ;	./src/write7219.c:55: Write7219(SHUT_DOWN, 0x01);                     // normal mode(0xX1)
      000B3E 75 3D 01         [24]  481 	mov	_Write7219_PARM_2,#0x01
      000B41 75 82 0C         [24]  482 	mov	dpl,#0x0c
      000B44 12 0A DC         [24]  483 	lcall	_Write7219
                                    484 ;	./src/write7219.c:56: Write7219(DISPLAY_TEST, 0x00); 
      000B47 75 3D 00         [24]  485 	mov	_Write7219_PARM_2,#0x00
      000B4A 75 82 0F         [24]  486 	mov	dpl,#0x0f
      000B4D 12 0A DC         [24]  487 	lcall	_Write7219
                                    488 ;	./src/write7219.c:57: Write7219(DECODE_MODE, 0x00);                   // select non-decode mode
      000B50 75 3D 00         [24]  489 	mov	_Write7219_PARM_2,#0x00
      000B53 75 82 09         [24]  490 	mov	dpl,#0x09
      000B56 12 0A DC         [24]  491 	lcall	_Write7219
                                    492 ;	./src/write7219.c:58: Write7219(SCAN_LIMIT, 0x07);                    // use all 8 LED
      000B59 75 3D 07         [24]  493 	mov	_Write7219_PARM_2,#0x07
      000B5C 75 82 0B         [24]  494 	mov	dpl,#0x0b
      000B5F 12 0A DC         [24]  495 	lcall	_Write7219
                                    496 ;	./src/write7219.c:59: Write7219(INTENSITY, 0x00);                     // set up intensity
      000B62 75 3D 00         [24]  497 	mov	_Write7219_PARM_2,#0x00
      000B65 75 82 0A         [24]  498 	mov	dpl,#0x0a
      000B68 12 0A DC         [24]  499 	lcall	_Write7219
                                    500 ;	./src/write7219.c:60: for (i = 1; i <= 8; i++) {
      000B6B 7F 01            [12]  501 	mov	r7,#0x01
      000B6D                        502 00102$:
                                    503 ;	./src/write7219.c:61: Write7219(i, 0x00);                         // turn off all LED
      000B6D 75 3D 00         [24]  504 	mov	_Write7219_PARM_2,#0x00
      000B70 8F 82            [24]  505 	mov	dpl,r7
      000B72 C0 07            [24]  506 	push	ar7
      000B74 12 0A DC         [24]  507 	lcall	_Write7219
      000B77 D0 07            [24]  508 	pop	ar7
                                    509 ;	./src/write7219.c:60: for (i = 1; i <= 8; i++) {
      000B79 0F               [12]  510 	inc	r7
      000B7A EF               [12]  511 	mov	a,r7
      000B7B 24 F7            [12]  512 	add	a,#0xff - 0x08
      000B7D 50 EE            [24]  513 	jnc	00102$
                                    514 ;	./src/write7219.c:63: }
      000B7F 22               [24]  515 	ret
                                    516 	.area CSEG    (CODE)
                                    517 	.area CONST   (CODE)
                                    518 	.area XINIT   (CODE)
